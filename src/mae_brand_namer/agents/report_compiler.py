...
class ReportCompiler:
    ...
    async def compile_report(self, run_id: str) -> Dict[str, Any]:
        """
        ...
        messages = self._format_messages(state_data)
        ...
        try:
            ...
            for row in response.data:
                if analysis_type == "brand_context":
                    required_fields = [
                        "brand_promise", "brand_mission", "brand_values", "brand_personality", 
                        "brand_tone_of_voice", "target_audience", "customer_needs", 
                        "market_positioning", "brand_identity_brief", "industry_focus",
                        "industry_trends", "competitive_landscape"
                    ]
                elif analysis_type == "brand_name_generation":
                    required_fields = [
                        "brand_name", "naming_category", "brand_personality_alignment",
                        "brand_promise_alignment", "memorability_score", "pronounceability_score",
                        "brand_fit_score", "meaningfulness_score"
                    ]
                elif analysis_type == "brand_name_evaluation":
                    required_fields = [
                        "brand_name", "strategic_alignment_score", "distinctiveness_score",
                        "memorability_score", "pronounceability_score", "meaningfulness_score",
                        "brand_fit_score", "domain_viability_score", "overall_score",
                        "shortlist_status", "evaluation_comments", "rank"
                    ]
                elif analysis_type == "competitor_analysis":
                    required_fields = [
                        "competitor_name", "competitor_positioning", "competitor_strengths",
                        "competitor_weaknesses", "differentiation_score", "risk_of_confusion",
                    ...
                    required_fields = [
                        ...
                        "market_viability", "potential_risks"
                    ]
                elif analysis_type == "semantic_analysis":
                    required_fields = [
                        "brand_name", "denotative_meaning", "etymology", "descriptiveness",
                        "concreteness", "emotional_valence", "brand_personality",
                        "sensory_associations", "figurative_language", "ambiguity",
                        "irony_or_paradox", "humor_playfulness", "phoneme_combinations",
                        "sound_symbolism", "rhyme_rhythm", "alliteration_assonance",
                        "word_length_syllables", "compounding_derivation", "brand_name_type",
                        "memorability_score", "original_pronunciation_ease",
                        "clarity_understandability", "uniqueness_differentiation",
                        "brand_fit_relevance", "semantic_trademark_risk"
                    ]
                    ...
                    required_fields = [
                        "brand_name", "persona_segment", "brand_promise_perception_score",
                        "personality_fit_score", "emotional_association",
                        "competitive_differentiation_score", "psychometric_sentiment_mapping",
                        ...
                        "industry", "company_size_employees", "company_revenue",
                        "market_share", "company_structure", "geographic_location",
                        "technology_stack", "company_growth_stage", "job_title",
                        "seniority", "years_of_experience", "department",
                        "education_level", "goals_and_challenges", "values_and_priorities",
                        "decision_making_style", "information_sources", "pain_points",
                        "technological_literacy", "attitude_towards_risk",
                        "purchasing_behavior", "online_behavior", "interaction_with_brand",
                        "professional_associations", "technical_skills", "networking_habits",
                        "professional_aspirations", "influence_within_company",
                        "event_attendance", "content_consumption_habits",
                        "vendor_relationship_preferences", "business_chemistry",
                        "reports_to", "buying_group_structure", "decision_maker",
                        "company_focus", "company_maturity", "budget_authority",
                        "preferred_vendor_size", "innovation_adoption",
                        "key_performance_indicators", "professional_development_interests",
                        "social_media_usage", "work_life_balance_priorities",
                        "frustrations_annoyances", "personal_aspirations_life_goals",
                        "motivations", "current_brand_relationships",
                        "product_adoption_lifecycle_stage", "purchase_triggers_events",
                        "success_metrics_product_service", "channel_preferences_brand_interaction",
                        "barriers_to_adoption", "generation_age_range",
                        "company_culture_values", "industry_sub_vertical",
                        "confidence_score_persona_accuracy", "data_sources_persona_creation",
                        "persona_archetype_type", "company_name"
                    ]
                else:
                    required_fields = []
                ...
                if missing_fields:
                    raise ValueError(f"Missing required fields for {analysis_type}: {', '.join(missing_fields)}")

            return response.data
        except Exception as e:
            logger.error(f"Error fetching {analysis_type} analysis: {str(e)}")
            raise
